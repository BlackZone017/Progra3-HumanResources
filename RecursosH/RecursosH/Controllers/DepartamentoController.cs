...
namespace RecursosH.Controllers
{
    public class DepartamentoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,codigoDepartamento,nombre,idManager")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,codigoDepartamento,nombre,idManager")] Departamento departamento)
        {
            if (ModelState.IsValid)
            {
